...
%\item[#1]#2.
%\StrDel{#1}{ }[\chaine]
%\StrDel{\chaine}{.}[\chaine]
%\StrDel{\chaine}{-}[\chaine]
%\StrDel{\chaine}{'}[\chaine]
%\StrSubstitute{\chaine}{é}{e}[\chaine]
%\StrSubstitute{\chaine}{œ}{oe}[\chaine]
%\StrSubstitute{\chaine}{æ}{ae}[\chaine]
%\StrSubstitute{\chaine}{É}{E}[\chaine]
%\StrSubstitute{\chaine}{È}{E}[\chaine]
%\StrSubstitute{\chaine}{ü}{u}[\chaine]
%\expandafter\global\expandafter\def\csname abbrev\chaine\endcsname{#1}
%\expandafter\global\expandafter\def\csname nomcomplet\chaine\endcsname{#2}
%}

\newcommand{\itbo}[2]{%
\item[#1]#2.
\directlua{if type(botaniste) == "table" then botaniste["#1"]="#2" else botaniste = {}, botaniste["#1"]="#2" end}}
...
\textcolor{\couleurTermeGlossaire}{\pdftooltip{#1}{#2}}}

\newcommand{\botaniste}[1]{%
\textcolor{\couleurBotaniste}{\pdftooltip{\csname abbrev#1\endcsname}{\csname nomcomplet#1\endcsname}}
}
